...
<body id="page-top">
  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top" id="mainNav">
    <div class="container">
      <a class="navbar-brand js-scroll-trigger" href="#page-top">COVA19_INFORMER</a>
  ...
  <header class="bg-primary text-white" >
    <div class="container text-center" style="height:3vh" >
      <h1>COVA19_INFORMER</h1>
  ...
  <div id="carouselExampleControls" class="carousel slide" style="width:90vw,height:50vh" data-ride="carousel"  interval="2000" wrap="true">
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img class="d-block w-100" src="./img/b3.jpg"  style="width:90vw,height:50vh" alt="First slide" class="active">
    </div>
    <div class="carousel-item">
      <img class="d-block w-100" src="./img/b2.jpg" style="width:90vw,height:50vh" alt="Second slide">
    </div>
    <div class="carousel-item">
      <img class="d-block w-100" src="./img/b1.jpg" style="width:90vw,height:50vh" alt="Third slide">
    </div>
  </div>
